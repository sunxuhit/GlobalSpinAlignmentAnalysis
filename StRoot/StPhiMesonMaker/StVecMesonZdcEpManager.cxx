...
ClassImp(StVecMesonZdcEpManager)

//---------------------------------------------------------------------------------

StVecMesonZdcEpManager::StVecMesonZdcEpManager(int energy)
{
  mEnergy = energy;
  clearZdcEp();
}

StVecMesonZdcEpManager::~StVecMesonZdcEpManager()
{
  /* */
}

void StVecMesonZdcEpManager::clearZdcEp()
{
  mCent9 = -1;
  mRunIndex = -1;
  mVz_sign = -1;
...
void StVecMesonZdcEpManager::initZdcEp(int Cent9, int RunIndex)
{
  mCent9 = Cent9;
  mRunIndex = RunIndex;
}
...
void StVecMesonZdcEpManager::setZdcSmd(int eastwest, int verthori, int slat, const float zdcsmd) 
{
  mZdcSmd[eastwest][verthori][slat] = (zdcsmd > 0.) ? zdcsmd : 0.;
}

float StVecMesonZdcEpManager::getZdcSmd(int eastwest, int verthori, int slat)
{
...
void StVecMesonZdcEpManager::readGainCorr()
{
  string InPutFile = Form("StRoot/StVecMesonUtility/GainCorrPar/file_%s_ZdcGainCorrFac.root",vmsa::mBeamEnergy[mEnergy].c_str());
...
void StVecMesonZdcEpManager::setZdcSmdGainCorr(int eastwest, int verthori, int slat, const float zdcsmd)
{
...
float StVecMesonZdcEpManager::getZdcSmdGainCorr(int eastwest, int verthori, int slat)
{
  return mZdcSmd[eastwest][verthori][slat];
}

float StVecMesonZdcEpManager::getPosition(int eastwest, int verthori, int slat, int mode)
{
...
TVector2 StVecMesonZdcEpManager::getQEast(int mode) 
{
...
TVector2 StVecMesonZdcEpManager::getQWest(int mode)
{
  TVector2 qVector(0.0,0.0);
  float qXsum = 0.; float qYsum = 0.;
  float qXwgt = 0.; float qYwgt = 0.;
...
void StVecMesonZdcEpManager::readReCenterCorr()
{
  string InPutFile = Form("StRoot/StVecMesonUtility/ReCenterParameter/file_%s_ZdcReCenterParameter.root",vmsa::mBeamEnergy[mEnergy].c_str());
...
void StVecMesonZdcEpManager::setZdcSmdCenter()
{
...
void StVecMesonZdcEpManager::readShiftCorr()
{
  string InPutFile = Form("StRoot/StVecMesonUtility/ShiftParameter/file_%s_ZdcShiftParameter.root",vmsa::mBeamEnergy[mEnergy].c_str());
...
TVector2 StVecMesonZdcEpManager::ApplyZdcSmdShiftCorrEast(TVector2 qVector)
{
...
TVector2 StVecMesonZdcEpManager::ApplyZdcSmdShiftCorrWest(TVector2 qVector)
{
  TVector2 qVecShift(0.0,0.0);
  float Psi_ReCenter = TMath::ATan2(qVector.Y(),qVector.X());
  float delta_Psi = 0.0;
...
float StVecMesonZdcEpManager::AngleShift(float Psi_raw)
{
...
void StVecMesonZdcEpManager::readShiftCorrFull()
{
  string InPutFile = Form("StRoot/StVecMesonUtility/ShiftParameterFull/file_%s_ZdcShiftParameterFull.root",vmsa::mBeamEnergy[mEnergy].c_str());
  mFile_ShiftPar = TFile::Open(InPutFile.c_str());
...
TVector2 StVecMesonZdcEpManager::ApplyZdcSmdShiftCorrFull(TVector2 qVector)
{
  TVector2 qVecShift(0.0,0.0);
  float Psi_ReCenter = TMath::ATan2(qVector.Y(),qVector.X());
  float delta_Psi = 0.0;
...
TVector2 StVecMesonZdcEpManager::getQFull(TVector2 QEast, TVector2 QWest)
{
...
void StVecMesonZdcEpManager::readResolution()
{
  string InPutFile = Form("StRoot/StVecMesonUtility/Resolution/file_%s_ZdcResolution.root",vmsa::mBeamEnergy[mEnergy].c_str());
  mFile_Resolution = TFile::Open(InPutFile.c_str());
  p_mResolution = (TProfile*)mFile_Resolution->Get("p_mResolution");
}

void StVecMesonZdcEpManager::calResolution()
{
...
float StVecMesonZdcEpManager::getResolution(int Cent9)
{
