...
class StRunQAProManager
{
  public:
    ...
    // Run-by-Run QA
    void initRunQA();
    void fillRunQAEvt(int triggerBin, int runIndex, double refMult, double grefMult, double zdcX, double vx, double vy, double vz, int cutSelection);
    void fillRunQATrk(int triggerBin, int runIndex, double gDca, int nHitsFit, TVector3 pMom, TVector3 gMom, int cutSelection);
    void writeRunQA();
