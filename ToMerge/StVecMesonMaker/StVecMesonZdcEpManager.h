#ifndef StVecMesonZdcEpManager_h
#define StVecMesonZdcEpManager_h
...
class StVecMesonZdcEpManager : public TObject
{
  public:
    StVecMesonZdcEpManager(int energy);
    virtual ~StVecMesonZdcEpManager();
    void clearZdcEp();
  ...
  ClassDef(StVecMesonZdcEpManager,1)
};
