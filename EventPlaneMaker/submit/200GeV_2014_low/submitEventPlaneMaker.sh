...
##########Test Production##########
star-submit-template -template testEventPlaneMaker_low.xml -entities mode=$mode,energy=$energy,library=$library,codePath=$codePath,outPath=$outPath,listPath=$listPath,outDir=$outDir
##########Test Production##########
