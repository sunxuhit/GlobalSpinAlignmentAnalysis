...
void getEpdShiftPar(int beamType = 2)
{
  gStyle->SetOptStat(0);
...

  {
	...
	c_EpdQ1Shift->cd(1)->Clear(); c_EpdQ1Shift->cd(1); p_mEpdQ1SideShiftCosEast[iVz][iShift]->Draw("colz");
	c_EpdQ1Shift->cd(2)->Clear(); c_EpdQ1Shift->cd(2); p_mEpdQ1SideShiftSinEast[iVz][iShift]->Draw("colz");
	c_EpdQ1Shift->cd(3)->Clear(); c_EpdQ1Shift->cd(3); p_mEpdQ1SideShiftCosWest[iVz][iShift]->Draw("colz");
	c_EpdQ1Shift->cd(4)->Clear(); c_EpdQ1Shift->cd(4); p_mEpdQ1SideShiftSinWest[iVz][iShift]->Draw("colz");
	c_EpdQ1Shift->Update();
	c_EpdQ1Shift->Print(figName.c_str());

	for(int iGrp = 0; iGrp < mNumRingsGrps; ++iGrp)
	{
	  c_EpdQ1Shift->cd(1)->Clear(); c_EpdQ1Shift->cd(1); p_mEpdQ1GrpShiftCosEast[iVz][iShift][iGrp]->Draw("colz");
	  c_EpdQ1Shift->cd(2)->Clear(); c_EpdQ1Shift->cd(2); p_mEpdQ1GrpShiftSinEast[iVz][iShift][iGrp]->Draw("colz");
	  c_EpdQ1Shift->cd(3)->Clear(); c_EpdQ1Shift->cd(3); p_mEpdQ1GrpShiftCosWest[iVz][iShift][iGrp]->Draw("colz");
	  c_EpdQ1Shift->cd(4)->Clear(); c_EpdQ1Shift->cd(4); p_mEpdQ1GrpShiftSinWest[iVz][iShift][iGrp]->Draw("colz");
	  c_EpdQ1Shift->Update();
	  c_EpdQ1Shift->Print(figName.c_str());
	}
      }
...

  {
    ...
    for(int iCent = 0; iCent < mNumCentrality; ++iCent)
    {
      ...
      c_EpdEp1SideReCtrDist->cd(1)->Clear(); c_EpdEp1SideReCtrDist->cd(1); h_mEpdEp1SideReCtrEast[iCent]->ProjectionY()->Draw();
      c_EpdEp1SideReCtrDist->cd(2)->Clear(); c_EpdEp1SideReCtrDist->cd(2); h_mEpdEp1SideReCtrWest[iCent]->ProjectionY()->Draw();
      c_EpdEp1SideReCtrDist->cd(3)->Clear(); c_EpdEp1SideReCtrDist->cd(3); h_mEpdEp1SideReCtrFull[iCent]->ProjectionY()->Draw();
      c_EpdEp1SideReCtrDist->cd(4)->Clear(); c_EpdEp1SideReCtrDist->cd(4); h_mEpdEp1SideReCtrCorr[iCent]->Draw("colz");
